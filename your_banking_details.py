from tkinter import *
import random, other_banking_details, savings_details
import time
...
def call_this_module():
    ...
    lblInfo = Label(Tops , font =('arial', 20 , 'bold'), text = "8. You Banking Details", fg = "white",bg = "dark green", bd = 10 , anchor = 'w')
    ...
    def call_next(requested_action):
        ...
        if(requested_action == "next"):
            ...
            savings_details.call_this_module()
    # ============================================ customer 1 ==============================================
    ...
    customer_1_section = Label(form_body_left , pady = 10, font =('arial', 20, 'bold' ), text = "Second Customer", fg = "Steel Blue" , anchor = 'w')
    customer_1_section.grid(row = 0)

    lblInfo = Label(form_body_left, font =('arial', 15, "bold"), text = "Is this a personal or business account?", fg = "black" , anchor = 'w')
    lblInfo.grid(row = 1 )

    lblInfo = Label(form_body_left, font =('arial', 15, "bold"), text = "Personal", fg = "black" , anchor = 'w')
    lblInfo.grid(row = 2)
    ...
    lblInfo = Label(form_body_left, font =('arial', 15, "bold"), text = "Business", fg = "black" , anchor = 'w')
    lblInfo.grid(row = 4 )
    want_debit_checkbox1 = Checkbutton(form_body_left,  font = ('arial',16),text = "Yes", variable = want_debit_card1 ,bd = 5,)
    ...
    lblInfo = Label(form_body_right, font =('arial', 15, "bold"), text = "Is this a personal or business account?", fg = "black" , anchor = 'w')
    lblInfo.grid(row = 1 )

    lblInfo = Label(form_body_right, font =('arial', 15, "bold"), text = "Personal", fg = "black" , anchor = 'w')
    lblInfo.grid(row = 2)
    want_debit_checkbox1 = Checkbutton(form_body_right,  font = ('arial',16),text = "Yes", variable = want_debit_card1 ,bd = 5,)
    want_debit_checkbox1.grid(row = 3 ,sticky = 'w')

    lblInfo = Label(form_body_right, font =('arial', 15, "bold"), text = "Business", fg = "black" , anchor = 'w')
    lblInfo.grid(row = 4 )
    want_debit_checkbox1 = Checkbutton(form_body_right,  font = ('arial',16),text = "Yes", variable = want_debit_card1 ,bd = 5,)
    want_debit_checkbox1.grid(row = 5 ,sticky = 'w')
