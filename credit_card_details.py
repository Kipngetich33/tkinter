...
lblInfo = Label(Tops , font =('arial', 20 , 'bold'), text = "8.2 Credit Card Details", fg = "white",bg = "dark green", bd = 10 , anchor = 'w')
...
lblInfo = Label(form_body_left, font =('arial', 15, "bold"), text = "Do you hold a credit card?", fg = "black" , anchor = 'w')
lblInfo.grid(row = 1 )
...
lblInfo = Label(form_body_left, font =('arial', 15, "bold"), text = "If Yes How Many", fg = "black" , anchor = 'w')
...
lblInfo = Label(form_body_left, font =('arial', 15, "bold"), text = "Are any Lloyds Bank?", fg = "black" , anchor = 'w')
lblInfo.grid(row = 5 )
...
want_debit_checkbox1 = Checkbutton(form_body_left,  font = ('arial',16),text = "No", variable = want_debit_card1 ,bd = 5,)
want_debit_checkbox1.grid(row = 7 ,column = 1,sticky = 'w')

lblInfo = Label(form_body_left, font =('arial', 15, "bold"), text = "If Yes How Many, What is Your Credit Limit", fg = "black" , anchor = 'w')
lblInfo.grid(row = 8, column = 0 )
txtDrinks = Entry(form_body_left, font = ('arial',16,'bold'), textvariable = drinks , bd =10, insertwidth = 4, width = 20,
                        bg = "powder blue", justify = "right" )
txtDrinks.grid(row = 8, column = 1)

lblInfo = Label(form_body_left, font =('arial', 15, "bold"), text = "What other card type(s) do you hold?", fg = "black" , anchor = 'w')
lblInfo.grid(row = 9 )

want_debit_checkbox1 = Checkbutton(form_body_left,  font = ('arial',16),text = "Change Card", variable = want_debit_card1 ,bd = 5,)
want_debit_checkbox1.grid(row =10 ,column = 1,sticky = 'w')

want_debit_checkbox1 = Checkbutton(form_body_left,  font = ('arial',16),text = "Store Card", variable = want_debit_card1 ,bd = 5,)
want_debit_checkbox1.grid(row = 11 , column = 1,sticky = 'w')

lblInfo = Label(form_body_left, font =('arial', 15, "bold"), text = "Others (please specify)", fg = "black" , anchor = 'w')
lblInfo.grid(row = 12, column = 0 )
txtDrinks = Entry(form_body_left, font = ('arial',16,'bold'), textvariable = drinks , bd =10, insertwidth = 4, width = 20,
                        bg = "powder blue", justify = "right" )
txtDrinks.grid(row = 12, column = 1)
...
lblInfo = Label(form_body_right, font =('arial', 15, "bold"), text = "Do you hold a credit card?", fg = "black" , anchor = 'w')
lblInfo.grid(row = 1 )
...
lblInfo = Label(form_body_right, font =('arial', 15, "bold"), text = "If Yes How Many", fg = "black" , anchor = 'w')
lblInfo.grid(row = 4, column = 0 )
txtDrinks = Entry(form_body_right, font = ('arial',16,'bold'), textvariable = drinks , bd =10, insertwidth = 4, width = 20,
                        bg = "powder blue", justify = "right" )
txtDrinks.grid(row = 4, column = 1)

lblInfo = Label(form_body_right, font =('arial', 15, "bold"), text = "Are any Lloyds Bank?", fg = "black" , anchor = 'w')
lblInfo.grid(row = 5 )
...
lblInfo = Label(form_body_right, font =('arial', 15, "bold"), text = "If Yes How Many, What is Your Credit Limit", fg = "black" , anchor = 'w')
lblInfo.grid(row = 8, column = 0 )
txtDrinks = Entry(form_body_right, font = ('arial',16,'bold'), textvariable = drinks , bd =10, insertwidth = 4, width = 20,
                        bg = "powder blue", justify = "right" )
txtDrinks.grid(row = 8, column = 1)

lblInfo = Label(form_body_right, font =('arial', 15, "bold"), text = "What other card type(s) do you hold?", fg = "black" , anchor = 'w')
lblInfo.grid(row = 9 )

want_debit_checkbox1 = Checkbutton(form_body_right,  font = ('arial',16),text = "Change Card", variable = want_debit_card1 ,bd = 5,)
want_debit_checkbox1.grid(row =10 ,column = 1,sticky = 'w')

want_debit_checkbox1 = Checkbutton(form_body_right,  font = ('arial',16),text = "Store Card", variable = want_debit_card1 ,bd = 5,)
want_debit_checkbox1.grid(row = 11 , column = 1,sticky = 'w')

lblInfo = Label(form_body_right, font =('arial', 15, "bold"), text = "Others (please specify)", fg = "black" , anchor = 'w')
lblInfo.grid(row = 12, column = 0 )
txtDrinks = Entry(form_body_right, font = ('arial',16,'bold'), textvariable = drinks , bd =10, insertwidth = 4, width = 20,
                        bg = "powder blue", justify = "right" )
txtDrinks.grid(row = 12, column = 1)
...
previousbtn = Button(form_body_bottom,padx = 10 , pady = 5 , bd = 5, fg = "black", font = ('arial',10,'bold'),
                text = 'Previous', bg = "powder blue").grid(row = 1, column = 0)

nextbtn = Button(form_body_bottom,padx = 10 , pady = 5 , bd = 5, fg = "black", font = ('arial',10,'bold'),
