from tkinter import *
import random, personal_details_continuation_6, debit_card_details
import time
...
def call_this_module():
    ...
    lblInfo = Label(Tops , font =('arial', 20 , 'bold'), text = "1.2 Your residential details(Continued_2)", fg = "white",bg = "dark green", bd = 10 , anchor = 'w')
    ...
    def call_next(requested_action):
            ...
            if(requested_action == "next"):
                ...
                personal_details_continuation_6.call_this_module() 
    ...
    lblInfo = Label(form_body_left , font =('arial', 15), text = "Your correspondence address", fg = "black" , anchor = 'w')
    lblInfo.grid(row = 1)

    lblInfo = Label(form_body_left , font =('arial', 15), text = "(if different from your home address)", fg = "black" , anchor = 'w')
    lblInfo.grid(row = 2)
    ...
    lblInfo = Label(form_body_right , font =('arial', 15), text = "Your correspondence address", fg = "black" , anchor = 'w')
    lblInfo.grid(row = 1)

    lblInfo = Label(form_body_right , font =('arial', 15), text = "(if different from your home address)", fg = "black" , anchor = 'w')
    lblInfo.grid(row = 2)
