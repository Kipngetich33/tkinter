from tkinter import *
import random, personal_details_continuation_4, personal_details_continuation_6
import time
...
def call_this_module():
    ...
    lblInfo = Label(Tops , font =('arial', 20 , 'bold'), text = "1.2 Your residential details", fg = "white",bg = "dark green", bd = 10 , anchor = 'w')
    ...
    lblInfo = Label(form_body_left , font =('arial', 15), text = " Your home address (where you live)", fg = "black" , anchor = 'w')
    lblInfo.grid(row = 1)

    txtCustName = Entry(form_body_left, font = ('arial',15), textvariable = name_on_card ,insertwidth = 4, bd = 5,width = 10,
                            bg = "powder blue", justify = "right" )
    txtCustName.grid(row = 2 )
    ...
    lblInfo = Label(form_body_right , font =('arial', 15), text = " Your home address (where you live)", fg = "black" , anchor = 'w')
    lblInfo.grid(row = 1)
