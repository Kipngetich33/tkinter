from tkinter import *
import random, additional_personal_details, monthly_household_income
import time
...
def call_this_module():
    ...
    def call_next(requested_action):
            ...
            if(requested_action == "next"):
                monthly_household_income.call_this_module()
    ...
    lblInfo = Label(form_body_left, font =('arial', 15, "bold"), text = "How long have you worked for your current employer?", fg = "black" , anchor = 'w')
    lblInfo.grid(row = 1)

    lblInfo = Label(form_body_left , font =('arial', 15), text = "Years", fg = "black" , anchor = 'w')
    lblInfo.grid(row = 2)
    txtReference = Entry(form_body_left, font = ('arial',15), textvariable = fries , bd =5, insertwidth = 4, width =20,
                            bg = "powder blue", justify = "right" )
    txtReference.grid(row = 3)

    lblInfo = Label(form_body_left , font =('arial', 15), text = "Months", fg = "black" , anchor = 'w')
    lblInfo.grid(row = 4)
    txtReference = Entry(form_body_left, font = ('arial',15), textvariable = fries , bd =5, insertwidth = 4, width =20,
                            bg = "powder blue", justify = "right" )
    txtReference.grid(row = 5)

    lblInfo = Label(form_body_left, font =('arial', 15, "bold"), text = "How long have you worked for your previous employer?", fg = "black" , anchor = 'w')
    lblInfo.grid(row = 6)
    ...
    lblInfo = Label(form_body_left , font =('arial', 15 ,"bold"), text = "Is Your Employment Pensionable", fg = "black" , anchor = 'w')
    lblInfo.grid(row = 11)
    ...
    lblInfo = Label(form_body_right, font =('arial', 15, "bold"), text = "How long have you worked for your current employer?", fg = "black" , anchor = 'w')
    lblInfo.grid(row = 1)

    lblInfo = Label(form_body_right , font =('arial', 15), text = "Years", fg = "black" , anchor = 'w')
    lblInfo.grid(row = 2)
    txtReference = Entry(form_body_right, font = ('arial',15), textvariable = fries , bd =5, insertwidth = 4, width =20,
                            bg = "powder blue", justify = "right" )
    txtReference.grid(row = 3)
    ...
    lblInfo = Label(form_body_right, font =('arial', 15, "bold"), text = "How long have you worked for your previous employer?", fg = "black" , anchor = 'w')
    lblInfo.grid(row = 6)
    ...
    lblInfo = Label(form_body_right , font =('arial', 15 ,"bold"), text = "Is Your Employment Pensionable", fg = "black" , anchor = 'w')
    lblInfo.grid(row = 11)
